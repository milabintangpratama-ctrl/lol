// UPDATE NEW H2 LIKEY HUMAN + authproxy by shiro + AUTO RESTART
...
const options = {
    ...
    auth: has_flag('--auth'),
    autoRestart: has_flag('--true')  // FLAG BARU UNTUK AUTO RESTART
};
...
Options:
  ...
  --true                      Auto restart attack after completion
...
function startAttack() {
    attackCount++;
    console.log(`\n\x1b[36m╔════════════════════════════════════════════════════════════╗\x1b[0m`);
    console.log(`\x1b[36m║           ATTACK CYCLE #${attackCount} STARTED               ║\x1b[0m`);
    ...
    if (cluster.isMaster) {
        ...
        console.log('Thread(s): '+args.threads);
        ...
        const attackTimeout = setTimeout(() => {
            ...
            if (options.autoRestart) {
                console.log(`\x1b[33m[SYSTEM]\x1b[0m Auto restart enabled, waiting 5 seconds before next attack...\n`);
                setTimeout(() => {
